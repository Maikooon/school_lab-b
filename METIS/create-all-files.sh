...
cat ./by-my-own-division/$GRAPH/community_C.txt ./by-my-own-division/$GRAPH/community_D.txt > ./by-my-own-division/$GRAPH/server_abilene06_edges_community.txt
cat ./by-my-own-division/$GRAPH/community_E.txt ./by-my-own-division/$GRAPH/community_F.txt > ./by-my-own-division/$GRAPH/server_abilene11_edges_community.txt

# Step 2-3: Remove the no longer needed community files
rm ./by-my-own-division/$GRAPH/community_A.txt
rm ./by-my-own-division/$GRAPH/community_B.txt
rm ./by-my-own-division/$GRAPH/community_C.txt
rm ./by-my-own-division/$GRAPH/community_D.txt
rm ./by-my-own-division/$GRAPH/community_E.txt
