...
# 変数をエクスポート
export GRAPH="ng_0.1/METIS-karate"  # グラフを格納するファイルの名前
export GRAPH_NAME="karate"  # 正規のグラフの名前
export GRAPH_COMMUNITY="METIS-karate"  # NGノードを含むグラフの名前
export NG_RATE=0.15  # NGノードの割合
