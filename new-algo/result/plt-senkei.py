...
# # ファイル名
# # データの準備
# total_moves = [1547, 1399, 1410, 1433, 1354]  # Total moves across communities
# execution_times = [
#     49831541,
#     45417000,
#     45252667,
#     47331750,
#     44340375,
# ]  # Program execution time (in nanoseconds)
...
# plt.savefig("./fb-caltech-connected/fb-caltech-connected-senkei.png")
# # グラフを表示
# plt.show()
