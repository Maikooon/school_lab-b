/*
 ...
 g++ -std=c++17 -o calc-ave calculate-average.cpp
 */
...
int main()
{
    ...
    // 固定値
    const std::string graphInfoFile = "./calc.txt";
    // 解析したいフォルダに格納される
    // const fs::path outputFilePath = "./result/overall_average_results.txt";
    const fs::path outputFilePath = BASEFOLDER / BASEFOLDER + "overall_average_results.txt";
